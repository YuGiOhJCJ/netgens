...
int Write_Sound_Buffer (void *Dump_Buf)
{
  ...
  if (Sound_Stereo)
    {
      if (Have_MMX) Write_Sound_Stereo_MMX (Seg_L, Seg_R, (short *) (audiobuf + audio_len), Seg_Lenght);
      else Write_Sound_Stereo ((short *) (audiobuf + audio_len), Seg_Lenght);
    }
  else
    {
      if (Have_MMX) Write_Sound_Mono_MMX (Seg_L, Seg_R, (short *) (audiobuf + audio_len), Seg_Lenght);
      else Write_Sound_Mono ((short *) (audiobuf + audio_len), Seg_Lenght);
    }
